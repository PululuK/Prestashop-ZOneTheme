...
<div class="category-block">
  <div class="category-container">
    <div class="category-image">
      {if isset($category.image.bySize.$imageName)}
        <a href="{$category.url}">
          <img
            class="img-fluid"
            src="{$category.image.bySize.$imageName.url}"
            alt="{$category.meta_title}"
            width="{$category.image.bySize.$imageName.width}"
            height="{$category.image.bySize.$imageName.height}"
          />
        </a>
      {/if}
    </div>
